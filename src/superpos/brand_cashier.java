 ...
 * @author Breeze
 */
public class brand_cashier extends javax.swing.JFrame {

    /**
     * Creates new form category
     */
    public brand_cashier() {
        initComponents();
        table_update();
    }
    ...
    private void table_update() {
        ...
        try {
            ...
            Logger.getLogger(brand_cashier.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(brand_cashier.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new brand_cashier().setVisible(true);
            }
        });
    }
