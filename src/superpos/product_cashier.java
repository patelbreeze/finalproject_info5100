 ...
 * @author Breeze
 */
public class product_cashier extends javax.swing.JFrame {

    /**
     * Creates new form category
     */
    public product_cashier() {
        initComponents();
        table_update();
        category();
        brand();
    ...
    private void table_update() {
        ...
        try {
            ...
            Logger.getLogger(product_cashier.class.getName()).log(Level.SEVERE, null, ex);
...
//        txtStatus.setSelectedItem(d1.getValueAt(selectIndex, 9).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(product_cashier.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new product_cashier().setVisible(true);
            }
        });
    }
