 ...
 * @author Breeze
 */
public class cashier_cashier extends javax.swing.JFrame {

    /**
     * Creates new form category
     */
    public cashier_cashier() {
        initComponents();
        table_update();
    }
    ...
    private void table_update() {
        ...
        try {
            ...
            Logger.getLogger(cashier_cashier.class.getName()).log(Level.SEVERE, null, ex);
...
//        txtStatus.setSelectedItem(d1.getValueAt(selectIndex, 2).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cashier_cashier.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cashier_cashier().setVisible(true);
            }
        });
    }
